...
const usersData = [
  {
    ...
    relativeName: 'LATE SRI RAM JIVAN BANSAL',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'VIJAY KUMAR AGRAWAL',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'Lt  SHREE LALIT AGRAWAL',
    relationship: 'S/O',
  ...
  },
  {
    ...
    city: 'Raipur - Raipur',
    address: 'House No 93\r\nHamming cotery \r\nKachna',
    relativeName: 'Late Sh. Laxman Agrawal',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'Late shree Ramkumar goyal',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'Sri NARAYAN AGRAWAL',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'Lt SRI PRADEEP AGRAWAL',
    relationship: 'S/O',
  ...
  },
  {
    ...
    relativeName: 'Late Shri Mohan lal Agrawal',
    relationship: 'S/O',
  ...
  },
  {
    ...
    address: 'RAJESH AGRAWAL SARAKTORA\r\n' +
      ...
      'BLOCK PITHORA \r\n' +
      'JILA MAHASMUND (CG.)',
    relativeName: 'LATE SHRI  MAHABIR AGRAWAL',
    relationship: 'S/O',
  ...
  try {
    ...
    for (let i = 0; i < sortedUsers.length; i++) {
      ...
      const userToInsert = {
        ...
        relativeName: userData.relativeName.toUpperCase(), // Convert to uppercase
        relationship: userData.relationship || 'S/O', // Use relationship from data or default to S/O
        passportPhoto: userData.passportPhoto,
        authProvider: userData.authProvider,
        isVerified: false, // Set to false for all users
        isMobileVerified: false, // Set to false for all users
        isEmailVerified: false, // Set to false for all users
