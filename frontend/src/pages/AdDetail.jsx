          ...
          <div className='bg-gradient-to-r from-blue-50 to-purple-50 p-2'>
            <div className='flex items-center justify-center bg-white rounded-lg shadow-md p-2'>
              <img
                ...
                className='max-w-full max-h-[160px] md:max-h-[200px] object-contain'
              />
            </div>
          </div>
        </div>
          ...
          <div className='p-4 space-y-3'>
            ...
            <div className='flex items-start gap-2 pb-3 border-b border-gray-200'>
              ...
              <div className='flex-1'>
                ...
                <p className='text-sm font-semibold text-gray-800'>{vendor.businessName}</p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-2 pb-3 border-b border-gray-200'>
              ...
              <div className='flex-1'>
                ...
                <p className='text-sm font-semibold text-gray-800'>{vendor.category}</p>
              </div>
            </div>
            ...
            <div className='flex items-start gap-2'>
              ...
              <div className='flex-1'>
                ...
                <p className='text-sm font-semibold text-gray-800'>{vendor.mobile}</p>
              </div>
            </div>
          </div>

          {/* Action Buttons */}
          <div className='bg-gray-50 px-4 py-3 flex flex-row gap-2'>
            <a
              href={`tel:${vendor.mobile}`}
              className='flex-1 bg-gradient-to-r from-green-600 to-green-700 text-white px-3 py-2 rounded-lg text-sm font-semibold hover:from-green-700 hover:to-green-800 transition-all shadow-md flex items-center justify-center gap-1.5'
            >
            ...
            <a
              ...
              className='flex-1 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-3 py-2 rounded-lg text-sm font-semibold hover:from-blue-700 hover:to-blue-800 transition-all shadow-md flex items-center justify-center gap-1.5'
            >
