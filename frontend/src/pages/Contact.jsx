          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            ...
            <div className='bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 border-2 border-gray-200'>
              ...
              <div className='text-center mb-4'>
                <a href='mailto:info@abcd.com' className='text-blue-600 font-bold hover:underline block mb-3'>
                  info@abcd.com
                </a>
                <a href='mailto:support@abcd.com' className='text-blue-600 font-bold hover:underline block'>
                  support@abcd.com
                </a>
              </div>
            ...
            <div className='bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all transform hover:-translate-y-2 border-2 border-gray-200'>
              ...
              <div className='text-center mb-4'>
                <a href='tel:+911234567890' className='text-blue-600 font-black text-2xl hover:underline block mb-2'>
                  +91 123 456 7890
                </a>
