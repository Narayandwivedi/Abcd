  ...
  return (
    <div ref={dropdownRef} className='relative' onKeyDown={handleKeyDown}>
      ...
      <div
        ...
        className={`w-full px-3 md:px-4 py-2 md:py-3 pl-9 md:pl-11 ${darkMode
      ...
      {isOpen && (
        <div
          className={`absolute z-50 w-full mt-2 ${darkMode ? 'bg-gray-800' : 'bg-white'
            } border ${darkMode ? 'border-white/20' : 'border-gray-300'
            ...
            {loading ? (
              ...
              filteredCities.map((city, index) => (
                <div
                  ...
                  className={`px-3 md:px-4 py-2 md:py-2.5 cursor-pointer transition-colors text-xs md:text-sm ${value === city
                      ? darkMode
              ...
              <div
                className={`px-3 md:px-4 py-6 text-center ${darkMode ? 'text-gray-400' : 'text-gray-500'
                  } text-xs md:text-sm`}
              >
                No cities found
              </div>
